...
// bool SCD4x::begin(bool measBegin, bool autoCalibrate, bool skipStopPeriodicMeasurements)
// {
...
//   uint8_t i2cResult;
//     char cmd[2];
//     cmd[0] = SCD4x_COMMAND_STOP_PERIODIC_MEASUREMENT >> 8;
//     cmd[1] = SCD4x_COMMAND_STOP_PERIODIC_MEASUREMENT & 0xFF;
//     i2cResult = i2c.write(SCD4x_ADDRESS,cmd,2);
//    return (i2cResult);
// }
...
//   i2cPort->beginTransmission(SCD4x_ADDRESS);
//   cmd[0] = SCD4x_COMMAND_READ_MEASUREMENT >> 8;
//    cmd[1] = SCD4x_COMMAND_READ_MEASUREMENT & 0xFF;
